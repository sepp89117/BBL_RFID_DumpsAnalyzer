...
def parse_rfid_tag(file_path):
    try:
        ...
        return {
            ...
            "min_nozzle_diameter": round(get_float(block(8) + 12), 2),
            ...
            "manufacturer_id": get_u16(block(10) + 4), # deviating from Bambu-Research-Group RFID-Tag-Guide -> Doesn't seem to be the spool width
            "prod_datetime": get_str(block(12), 16),
            "batch_id": get_str(block(13), 16), # deviating from Bambu-Research-Group RFID-Tag-Guide -> Doesn't seem to be short production date
...
def main():
    ...
    # G:\BambuFilaments\Dumps --output data.json
